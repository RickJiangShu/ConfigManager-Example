...
public class EquipSheet
{
    ...
    private static Dictionary<uint, EquipSheet> dictionary = new Dictionary<uint, EquipSheet>();

    /// <summary>
    /// 通过EquipId获取EquipSheet的实例
    /// </summary>
    /// <param name="EquipId">索引</param>
    /// <returns>EquipSheet的实例</returns>
    public static EquipSheet Get(uint EquipId)
    {
    ...
    /// </summary>
    /// <returns>字典</returns>
    public static Dictionary<uint, EquipSheet> GetDictionary()
    {
        return dictionary;
    }
    ...
    public static EquipSheet[] GetValues()
    {
        int count = dictionary.Values.Count;
        EquipSheet[] values = new EquipSheet[count];
